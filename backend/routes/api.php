...
use App\Http\Controllers\Api\MarketplaceAppealController;
use App\Http\Controllers\Api\MarketplaceFeedbackController;
use App\Http\Controllers\Api\MarketplaceOnboardingController;
...
Route::middleware(['auth:sanctum', 'account.active'])->group(function () {
    ...
    Route::post('/security/two-factor/setup', [SecurityController::class, 'setup'])->middleware('throttle:5,1');
    Route::post('/security/two-factor/confirm', [SecurityController::class, 'confirm'])->middleware('throttle:8,1');
    Route::delete('/security/two-factor', [SecurityController::class, 'disable'])->middleware('throttle:5,1');
    ...
    Route::get('/onboarding', [MarketplaceOnboardingController::class, 'show']);
    Route::post('/onboarding/reward', [MarketplaceOnboardingController::class, 'claimReward'])->middleware('throttle:5,1');
    ...
    Route::post('/feedback', [MarketplaceFeedbackController::class, 'store'])->middleware('throttle:5,1');
    Route::get('/reliability-appeals', [MarketplaceAppealController::class, 'index']);
    Route::post('/reliability-events/{reliabilityEvent}/appeals', [MarketplaceAppealController::class, 'store'])->middleware('throttle:5,1');
    ...
    Route::prefix('admin')->middleware('ability:admin')->group(function () {
        ...
        Route::patch('/appeals/{appeal}', [AdminController::class, 'updateAppeal']);
