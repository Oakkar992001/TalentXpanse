...
function PolicyPage({ type }) {
  const content = {
    Terms: ['Terms of use', 'Clear rules help TalentXpanse remain fair for clients and freelancers. Current version: 30 July 2026.', ['Use TalentXpanse honestly and keep account information accurate.', 'Keep proposals, project scope, delivery, and payments on the platform when features are available.', 'Do not post illegal, misleading, discriminatory, or abusive content.', 'TalentXpanse may restrict content or accounts that break marketplace rules.']],
    Privacy: ['Privacy', 'We collect only the data needed to operate a marketplace safely and improve the service. Current version: 30 July 2026.', ['Your profile and portfolio details may be visible where you choose to make them public.', 'Private messages, delivery files, account records, and verification requests are handled as restricted marketplace data.', 'You can request help with your account data or account closure through support. Closure must preserve active-project, dispute, and legally required payment records.', 'Payment and identity data will receive additional safeguards before those services launch.']],
    MarketplaceRules: ['Marketplace rules', 'Professional, documented collaboration protects both sides of a project. Current version: 30 July 2026.', ['Write clear job posts and proposals. Do not misrepresent skills, experience, work, or identity.', 'Use milestones, documented revisions, scope changes, and support requests to resolve project issues.', 'Do not ask another person to make an off-platform payment or share sensitive verification documents through chat.']],
  }[type]
