  ...
  return <section className="workspace-setup"><div className="workspace-setup-card">
    ...
    <form onSubmit={submit}>
      {isClient ? <>
        ...
        <label>{t('setup.industry', 'Industry')} <small>{t('common.optional', 'Optional')}</small><input value={form.industry} onChange={(event) => setForm({ ...form, industry: event.target.value })} placeholder={t('setup.industry_hint', 'Enter your industry')} /></label>
        ...
        <label>{t('setup.website', 'Website')} <small>{t('common.optional', 'Optional')}</small><input type="url" value={form.website} onChange={(event) => setForm({ ...form, website: event.target.value })} /></label>
        ...
        <label>{t('profile.title', 'Professional title')}<input value={form.title} onChange={(event) => setForm({ ...form, title: event.target.value })} placeholder={t('setup.freelancer_title_hint', 'Enter your professional title')} /></label>
