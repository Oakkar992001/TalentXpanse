  ...
  return <section className="settings-page">
    ...
    <div className="settings-layout"><SettingsSidebar /><main>
      ...
      {!account ? <p className="settings-loading">Loading account settings…</p> : section === 'information' ? <>
        ...
        <section className="settings-card settings-note"><h2>Privacy and account closure</h2><p>Data exports and account-closure requests will be available once payment records and a support process are in place. This prevents project or financial records from being removed improperly.</p></section>
